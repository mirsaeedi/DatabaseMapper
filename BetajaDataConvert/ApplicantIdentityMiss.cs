...
{
    class ApplicantIdentityMiss
    {
        public static void FindNonDuplicate()
        {
            string tableLeft = "TblPrs";
            string columnLeft = "HoviatKhedmatiCod";
            string tableRight = "hoviatkhedmati";
            ...
            query = string.Format(query, "dbo.applicantidentity", "id", "description");
